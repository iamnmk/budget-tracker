...
export default function PDFDropzone() {
  ...
  const processUpload = useCallback(
    async (files: FileList | File[], accountId?: string) => {
      if (!user) {
      ...
      try {
        ...
        for (const file of pdfFiles) {
          ...
          // If an account was selected, include that in the form data
          if (accountId) {
  ...
  const handleUpload = useCallback(
    (files: FileList | File[]) => {
      // Store the files and show the account selection dialog
  ...
  const handleAccountSelected = useCallback(
    (accountId: string) => {
      if (pendingFiles) {
        processUpload(pendingFiles, accountId);
      }
  ...
  const handleAccountDialogClosed = useCallback(() => {
    setShowAccountDialog(false);
    setPendingFiles(null);
  }, []);
  ...
  return (
    <>
      ...
      <SelectAccountDialog
        ...
        onClose={handleAccountDialogClosed}
